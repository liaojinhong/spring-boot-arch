...
public class DataUtils {
    ...
    /**
     * 把Object对象转换为DateTime对象（DateTime类是java.util.Date的子类）。
     * 
     * @param object
     * @return DateTime对象或null（如果object是null）。
     */
    public static DateTime getDateTime(Object object) {
        DateTime dateTime = null;
        if(object != null) {
            if(object.getClass() == Date.class) {
                dateTime = new DateTime((Date)object, DateTime.YEAR_TO_DAY);
            }
            else if(object.getClass() == Timestamp.class) {
                dateTime = new DateTime((Timestamp)object,
                        DateTime.YEAR_TO_SECOND);
            }
            else {
                dateTime = new DateTime((java.util.Date)object);
            }
        }
        return dateTime;
    }
